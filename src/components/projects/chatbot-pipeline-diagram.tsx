    ...
    >
      ...
      {PIPELINE_STEPS.map((s) => (
        <motion.g key={s.n} variants={step}>
          ...
          <text x={s.x + BOX_W / 2} y={BOX_Y + 68} fontSize="20" fontWeight="600" textAnchor="middle" className="fill-[#171717] dark:fill-white">
            {s.title}
          </text>
          <text x={s.x + BOX_W / 2} y={BOX_Y + 100} fontSize="16" textAnchor="middle" className="fill-[#888888] dark:fill-zinc-500">
            {s.sub}
          </text>
        </motion.g>
      ))}
