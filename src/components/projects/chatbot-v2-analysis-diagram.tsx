    ...
    >
      ...
      {ROUTE_CARDS.map((c) => (
        <motion.g key={c.label} variants={step}>
          ...
          <text x={c.cx} y="114" textAnchor="middle" fontSize="12" fontWeight="700" fontFamily="ui-monospace, SFMono-Regular, Menlo, monospace" className="fill-white">
            {c.label}
          </text>
          {c.lines.map((line, i) => (
            <text key={line} x={c.cx} y={150 + i * 18} textAnchor="middle" fontSize="12" className="fill-[#888888] dark:fill-zinc-500">
              {line}
            </text>
          ))}
        </motion.g>
      ))}
      <motion.text variants={fade} x="590" y="146" textAnchor="middle" fontSize="20" fontWeight="700" className="fill-red-600 dark:fill-red-500">
        ……
      </motion.text>
      <motion.text variants={fade} x="590" y="168" fontSize="11" textAnchor="middle" className="fill-[#888888] dark:fill-zinc-500">
        (21개 라우트)
      </motion.text>
      ...
      <motion.g variants={step}>
        ...
        <text x={QUERY_CX} y="114" textAnchor="middle" fontSize="12" fontWeight="700" className="fill-white">
          사용자 질문 (매 요청)
        </text>
        <text x={QUERY_CX} y="150" textAnchor="middle" fontSize="12" className="fill-[#888888] dark:fill-zinc-500">
          &quot;지금 실내 공기질 어때?&quot;
        </text>
      </motion.g>
      ...
      <motion.g variants={step}>
        ...
        <text x="418" y="257" textAnchor="start" fontSize="16" fontWeight="600" className="fill-white dark:fill-[#171717]">
      ...
      <motion.g variants={step}>
        ...
        <text x="565" y="650" textAnchor="middle" fontSize="14" fontWeight="700" className="fill-blue-700 dark:fill-blue-400">
          Cosine Similarity
        </text>
      </motion.g>
      ...
      <motion.g variants={step}>
        ...
        <text x="785" y="638" textAnchor="middle" fontSize="14" fontWeight="700" className="fill-orange-700 dark:fill-orange-400">
          threshold
        </text>
        <text x="785" y="660" textAnchor="middle" fontSize="16" fontWeight="700" className="fill-orange-700 dark:fill-orange-400">
          0.47
        </text>
      </motion.g>
      ...
      <motion.g variants={step}>
        ...
        <text x="1050" y="590" textAnchor="middle" fontSize="15" fontWeight="600" className="fill-white dark:fill-[#171717]">
          확신 라우팅
        </text>
      ...
      <motion.g variants={step}>
        ...
        <text x="1050" y="690" textAnchor="middle" fontSize="15" fontWeight="600" className="fill-[#4d4d4d] dark:fill-zinc-400">
          DSPy 저신뢰 폴백
        </text>
      ...
      <text x="40" y="790" fontSize="14" className="fill-[#888888] dark:fill-zinc-500">
