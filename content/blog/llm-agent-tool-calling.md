---
title: "LLM에이전트가 도구를 호출하는 방법"
date: 2025-08-01
tag: Agent
summary: "LLM이 도구를 호출하는 방법"
draft: false
---

![LLM 에이전트 구조: User request와 Agent가 상호작용하고, Agent가 Planning, Memory, Tools와 연결된 다이어그램](/blog/llm-agent-structure.svg)
